...
public interface NetworkConfig extends Config {
    ...
    interface Descriptions {
        String PROB2 = DescriptionHelper.getProbOf();
        String UDP_RECEIVER_PORT = "The UDP Receiver Port.";
        String TCP_RECEIVER_PORT = "The TCP Receiver Port.";
        String P_REMOVE_REQUEST = "A number between 0 and 1 that represents the probability of  stopping to request a transaction. This number should be " +
        ...
        String P_DROP_CACHE_ENTRY =   "A number between 0 and 1 that represents the probability of  dropping recently seen transactions out of the network cache.";
